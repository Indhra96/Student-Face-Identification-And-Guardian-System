...
def ask():
   ...
   if value=="yes":
      x=databaseEnter()
      if(x==1):
         tmsg.showinfo("Success","Complaint Recorded Successfully")
         root.destroy()
      else:
...
label_10 = Label(root, text="Student Face Identification System",width=85,font=("bold", 20),anchor=CENTER,bg="#386184",fg="white")
label_10.place(x=0,y=0)

             
label_0 = Label(root, text="Complaint Form",width=95,font=("bold", 16),bg="#180020",fg='white')
