...
class App:
  ...
  def viewdetail(self,a):
    ...
    label_father = Label(self.window, text="CC",bg="#382273",fg='yellow',width=20,font=("bold", 12))
    label_father.place(x=930,y=430)
    label_mother = Label(self.window, text="Year and Section",bg="#382273",fg='yellow',width=20,font=("bold", 12))
    ...
    label_religion = Label(self.window, text="Department",bg="#382273",fg='yellow',width=20,font=("bold", 12))
    ...
    label_body = Label(self.window, text="DOB",bg="#382273",fg='yellow',width=20,font=("bold", 12))
    label_body.place(x=930,y=580)
    label_nat = Label(self.window, text="RegNo",bg="#382273",fg='yellow',width=20,font=("bold", 12))
    label_nat.place(x=930,y=610)
    label_crime = Label(self.window, text="Complaint",bg="#382273",width=23,font=("bold", 15),fg="red")
    ...
    if isTrue:
      ...
      #   Id, confidence = self.recognizer.predict(self.gray[y:y+h,x:x+w])
          ...
          if not matches[best_match_index]:
                  messagebox.showinfo("Unknown Face Detected", "An unknown face has been detected!")  
