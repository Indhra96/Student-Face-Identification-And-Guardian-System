...
label_0 = Label(root, text="Student Face Identification System",width=87,font=("bold", 20),anchor=CENTER,bg="grey",fg="white")
...
def viewdetail(a):
   ...
   label_mother = Label(root, text="Year and Section",bg="#382273",fg='yellow',width=20,font=("bold", 12))
   ...
   label_religion = Label(root, text="Department",bg="#382273",fg='yellow',width=20,font=("bold", 12))
   ...
   label_crime = Label(root, text="Complaint :",bg="#382273",width=7,font=("bold", 15),fg="red")
...
def mfileopen():
   ...
   image = image.resize((400, 400), Image.LANCZOS)  # Resampling.LANCZOS is not valid, use Image.LANCZOS
   photo = ImageTk.PhotoImage(image)
...
btn_video = Button(text="Select Video", bg='lightblue', width=20, command=mfileopen).place(x=400, y=550)
